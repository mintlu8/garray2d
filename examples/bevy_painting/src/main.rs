...
use bevy::{asset::RenderAssetUsages, image::BevyDefault, prelude::*, render::render_resource::{Extent3d, TextureDimension}, window::{PresentMode, PrimaryWindow}};
...
fn setup(
    ...
    let bg = images.add(Image::new(Extent3d {
        width: 1024,
        height: 768,
        depth_or_array_layers: 1,
    }, TextureDimension::D2, vec![[255, 255, 255, 0]; 1024 * 768].into_flattened(), BevyDefault::bevy_default(), RenderAssetUsages::all()));
...
fn update(
    ...
    if mouse.pressed(MouseButton::Left) {
        ...
        array.paint(&BRUSH, at, |[_, _, _, a], b| *a = (*a).max((b * 255.) as u8));
    }
}